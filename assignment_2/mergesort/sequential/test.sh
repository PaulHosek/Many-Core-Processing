...
dir_asc="../../test/merge_sequential_length_asc"
dir_desc="../../test/merge_sequential_length_desc"
dir_rand="../../test/merge_sequential_length_rand"
...
do
    ...
    do
        ...
        prun -np 1 -v sequential -o ${output_file_asc} -l ${length} -a
        prun -np 1 -v sequential -o ${output_file_desc} -l ${length} -d
        prun -np 1 -v sequential -o ${output_file_rand} -l ${length} -r
    done
done