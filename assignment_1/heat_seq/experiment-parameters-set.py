...
plot_hi_lo(ax, ys_wide_k1, xs_wide_k1, wide_rects_k1['flops']['sem'],'#3AD684')
plot_hi_lo(ax, ys_wide_kmaxiter, xs_wide_kmaxiter, wide_rects_kmaxiter['flops']['sem'],'#517075')
ax.set(xlabel="Grid size", ylabel="Flops/s")
ax.legend()
